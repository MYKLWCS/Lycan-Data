...
PLATFORM_ACCEPTS: dict[str, list[str]] = {
    ...
    "phone_numlookup": ["phone"],
    "email_holehe": ["email"],
    "email_breach": ["email"],
    "email_emailrep": ["email"],
    "email_mx_validator": ["email"],
    "username_sherlock": ["username"],
    "whitepages": ["full_name"],
    "fastpeoplesearch": ["full_name"],
    "truepeoplesearch": ["full_name"],
    "people_thatsthem": ["full_name", "email", "phone"],
    "domain_whois": ["domain"],
...
KILL_SWITCHES: dict[str, str] = {
    ...
    "phone_numlookup": "enable_burner_check",
    "email_holehe": "enable_credit_risk",
    "email_breach": "enable_credit_risk",
    "email_emailrep": "enable_credit_risk",
    "email_mx_validator": "enable_credit_risk",
