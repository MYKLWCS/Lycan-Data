...
def main() -> None:
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            review = f"Gemini error (exit {result.returncode}): {result.stderr.strip()}"
    except FileNotFoundError:
        review = "Gemini CLI not found — automated review skipped."
    except subprocess.TimeoutExpired:
        review = "Gemini review timed out after 300s — automated review skipped."
    except Exception as exc:  # noqa: BLE001
        review = f"Gemini error ({exc}) — automated review skipped."
