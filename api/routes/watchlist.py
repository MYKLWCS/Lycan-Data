...
async def get_watchlist_matches(person_id: uuid.UUID, db: AsyncSession = DbDep, confirmed_only: bool = False):
    ...
    return {"matches": [{"id": str(r.id), "list_name": r.list_name, "list_type": r.list_type,
                          "match_score": r.match_score, "match_name": r.match_name,
                          "listed_date": r.listed_date, "reason": r.reason,
                          "source_url": r.source_url, "is_confirmed": r.is_confirmed,
