...
class DataSource(Base, TimestampMixin):
    ...
    source_type: Mapped[str] = mapped_column(String(50), nullable=False)  # social, clearweb, darkweb, registry
...
class CrawlJob(Base, TimestampMixin):
    ...
    job_type: Mapped[str] = mapped_column(String(50), nullable=False)  # social, enrichment, darkweb, freshness
